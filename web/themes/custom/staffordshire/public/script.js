(function($, Drupal, drupalSettings) {
    ...
    function alertHeight(context) {  
        var drawerHeight = $('.drawer').prop('scrollHeight') + 60;
        console.log(drawerHeight);
        if ($( ".header" ).hasClass( "has-drawer" )) {
            console.log('has a drawer');
            $('.home-wrap .has-drawer').css( "margin-top", drawerHeight );
        }
    }
